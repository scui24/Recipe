...
print("Hello, I'm a recipe chatbot! What do you want me to do?")

while True:
    start = input()
    # Commence allrecipes
    if "allrecipes" in start.lower(): 
            ...
            if step_number < len(steps):
                ...
                while flag:
                    ...
                    if nth_step_pattern.search(action): #2
                        ...
                        technique_query = "+".join(technique)
                        technique_string = " ".join(technique)
                        print(f"You can learn more about how to {technique_string} here: https://www.youtube.com/results?search_query=how+to+{technique_query}")
